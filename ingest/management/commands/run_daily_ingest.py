...
fetch_ec46, fetch_pollen, fetch_era5_backfill (rolling 14-day window). Meant
to run once/day via a dedicated Railway Cron service ("cron-daily") — NOT
part of the web service's Procfile, see CLAUDE.md for the dashboard setup
steps.
...
STEPS = ["fetch_seasonal", "fetch_ec46", "fetch_pollen", "fetch_era5_backfill"]


class Command(BaseCommand):
    help = "Run daily-cadence ingestion: fetch_seasonal, fetch_ec46, fetch_pollen, fetch_era5_backfill."
