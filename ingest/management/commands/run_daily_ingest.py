...
fetch_ec46, fetch_pollen, fetch_era5_backfill (rolling 14-day window), and
prune_notes (14/30-day note + Historie-pin expiry). Meant to run once/day via
a dedicated Railway Cron service ("cron-daily") — NOT part of the web
service's Procfile, see CLAUDE.md for the dashboard setup steps.
...
STEPS = ["fetch_seasonal", "fetch_ec46", "fetch_pollen", "fetch_era5_backfill", "prune_notes"]


class Command(BaseCommand):
    help = "Run daily-cadence ingestion: fetch_seasonal, fetch_ec46, fetch_pollen, fetch_era5_backfill, prune_notes."
