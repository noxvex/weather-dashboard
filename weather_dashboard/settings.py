...
# ManifestStaticFilesStorage requires a collectstatic manifest that doesn't
# exist in the test environment — fall back to plain storage under `manage.py test`.
if "test" in sys.argv:
